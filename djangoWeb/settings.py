...
SECRET_KEY = ')4jft9bu!21b#(=0i*qtlu5!4nztn*px-efk(0li9dx%(xozaj'
...
MEDIA_ROOT = os.path.join(BASE_DIR,'media') #root to store the profile pics folder 
MEDIA_URL  = '/media/' #Acess the directory in browser
